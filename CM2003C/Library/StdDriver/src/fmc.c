 ...
 * $Revision: 3 $
 * $Date: 18/04/24 3:05p $
 * @brief    CM2003 series FMC driver source file
 *
 * @note
...
int32_t FMC_Erase(uint32_t u32PageAddr)
{
    ...
    if ((u32PageAddr == FMC_SPROM_BASE) || (u32PageAddr == (FMC_SPROM_BASE + FMC_FLASH_PAGE_SIZE)))
    {
        return FMC_Erase_SPROM(u32PageAddr);
    }
...
/**
  * @brief Execute FMC_ISPCMD_PAGE_ERASE command to unlock SPROM.
