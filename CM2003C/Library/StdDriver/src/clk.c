 ...
 * @file     clk.c
 * @version  V0.10
 * @brief    CM2003C series Clock Controller (CLK) driver source file
 *
 * @note
...
/**
  ...
  * |\ref UART2_MODULE   |\ref CLK_CLKSEL2_UART2SEL_HIRC         |\ref CLK_CLKDIV0_UART2(x) |
  * |\ref UART2_MODULE   |\ref CLK_CLKSEL2_UART2SEL_PCLK0        |\ref CLK_CLKDIV0_UART2(x) |
