 ...
 * @file     pdma.h
 * @version  V1.00
 * @brief    CM2003 series PDMA driver header file
 *
...
/** @addtogroup PDMA_EXPORTED_CONSTANTS PDMA Exported Constants
  @{
*/
#define PDMA_CH_MAX    4UL   /*!< Specify Maximum Channels of PDMA  \hideinitializer */
...
#define PDMA_USCI2_TX    26UL /*!<DMA Connect to USCI2_TX \hideinitializer */
#define PDMA_USCI2_RX    27UL /*!<DMA Connect to USCI2_RX \hideinitializer */
#define PDMA_USCI3_TX    28UL /*!<DMA Connect to USCI3_TX \hideinitializer */
#define PDMA_USCI3_RX    29UL /*!<DMA Connect to USCI3_RX \hideinitializer */
...
#define PDMA_PWM1_P2_RX  36UL /*!<DMA Connect to PWM2_P2 \hideinitializer */
#define PDMA_PWM1_P3_RX  37UL /*!<DMA Connect to PWM3_P3 \hideinitializer */
