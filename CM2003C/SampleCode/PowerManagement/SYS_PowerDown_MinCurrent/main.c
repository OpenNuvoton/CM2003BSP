...
void GPB_IRQHandler(void)
{
    ...
    if(GPIO_GET_INT_FLAG(PB, BIT0))
    {
        ...
        printf("PB.0 interrupt occurred.\n");
    }
    else
    {
...
{
    printf("+-------------------------------------------------------------+\n");
    printf("|  SYS_PowerDown_MinCurrent and Wake-up by PB.0 Sample Code   |\n");
    printf("+-------------------------------------------------------------+\n\n");
    ...
    printf("|  6. Wait for PB.0 falling-edge interrupt event to wakeup the MCU        |\n");
    printf("+-------------------------------------------------------------------------+\n\n");
    ...
    /* Configure PB.0 as Quasi-bidirectional mode and enable interrupt by falling edge trigger */
    ...
    /* Waiting for PB.0 falling-edge interrupt event */
