...
void SYS_Init(void)
{
    ...
    /*----------------------------------*/
    /*
     * UART0 log on PB12/PB13(do not use Uart0DefaultMPF).
     */
    ...
    /* Set GPB multi-function pins for Timer0/Timer3 toggle-output pin and Timer1 event counter pin */
    ...
    /* Set GPB multi-function pin for Timer1 external capture pin */
...
void TIMER_FunctionTest()
{
    ...
    printf("+------------------------------------------+\n");
    printf("|    Timer Capture Counter Sample Code     |\n");
    printf("+------------------------------------------+\n\n");
