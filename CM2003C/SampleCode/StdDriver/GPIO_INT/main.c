...
void GPIO_FunctionTest()
{
    ...
    /*-----------------------------------------------------------------------------------------------------*/
    printf("PB.5, PB.4, and PB.0 are used to test interrupt\n");
    printf("    PB.5 is falling edge trigger.\n");
    printf("    PB.4 is rising edge trigger.\n");
    printf("    PB.0 is both falling edge and rising edge trigger.\n");
    ...
    /* Configure PB.0 as Input mode and enable interrupt by falling and rising edge trigger */
    ...
    GPIO_ENABLE_DEBOUNCE(PB, BIT5 | BIT4 | BIT0);
}
