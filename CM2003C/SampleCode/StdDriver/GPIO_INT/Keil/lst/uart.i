...
# 88 "../../../../Library/StdDriver/src/uart.c"
void UART_Close(UART_T* uart)
{
    uart->INTEN = 0ul;
}
# 103 "../../../../Library/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T* uart)
{
    uart->INTEN &= ~((0x1ul << (12)) | (0x1ul << (13)));
}
# 130 "../../../../Library/StdDriver/src/uart.c"
void UART_DisableInt(UART_T* uart, uint32_t u32InterruptFlag)
{

    ((uart)->INTEN &= ~ (u32InterruptFlag));
}
# 146 "../../../../Library/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T* uart)
{
...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    else if (uart == (UART_T *)((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x32000UL)))
    {
        ...
        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL2 & (0x7ul << (28))) >> (28);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 & (0xful << (24))) >> (24);
    }
...
# 279 "../../../../Library/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T* uart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
...
# 341 "../../../../Library/StdDriver/src/uart.c"
void UART_SetLine_Config(UART_T *uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
...
# 437 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
...
# 523 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T* uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 547 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectLINMode(UART_T* uart, uint32_t u32Mode, uint32_t u32BreakLength)
{
...
# 612 "../../../../Library/StdDriver/src/uart.c"
void UART_SelectSingleWireMode(UART_T *uart)
{
