...
# 105 "../../../../Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 124 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetHXTFreq(void)
{
...
# 139 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetHCLKFreq(void)
{
...
# 211 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
...
# 239 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    uint32_t u32HIRCSTB;
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 & (~(0xfful << (0)))) | u32ClkDiv;
...
# 327 "../../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 485 "../../../../Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
...
# 506 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 589 "../../../../Library/StdDriver/src/clk.c"
int32_t CLK_SetPowerDownMode(uint32_t u32PDMode)
{
    uint32_t u32TimeOutCnt = SystemCoreClock * 2;
...
# 625 "../../../../Library/StdDriver/src/clk.c"
int32_t CLK_EnableDPDWKPin(uint32_t u32TriggerType)
{
    uint32_t u32TimeOutCnt = SystemCoreClock * 2;
...
# 689 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableSPDWKPin(uint32_t u32Port, uint32_t u32Pin, uint32_t u32TriggerType, uint32_t u32DebounceEn)
{
