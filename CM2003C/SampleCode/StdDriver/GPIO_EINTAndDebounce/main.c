...
void SYS_Init(void)
{
    ...
    /* Set multi-function pin for EINT0 (PB.5), EINT1 (PB.4), and EINT2 (PC.6) */
    ...
    SYS->GPC_MFPL = (SYS->GPC_MFPL & ~SYS_GPC_MFPL_PC6MFP_Msk) | SYS_GPC_MFPL_PC6MFP_INT2;
...
void GPIO_FunctionTest()
{
    ...
    /*-----------------------------------------------------------------------------------------------------*/
    printf("EINT0 (PB.5), EINT1 (PB.4), and EINT2 (PC.6) are used to test interrupt\n");
    printf("    PB.5 is falling edge trigger.\n");
    printf("    PB.4 is rising edge trigger.\n");
    printf("    PC.6 is both falling edge and rising edge trigger.\n");
    ...
    /* Configure PC.6 as EINT2 pin and enable interrupt by falling and rising edge trigger */
    ...
    GPIO_ENABLE_DEBOUNCE(PB, BIT5 | BIT4);
