 ...
 *           function. Also displays the measured input frequency to
 *           UART console.
 *
...
void SYS_Init(void)
{
    ...
    /* Set GPB multi-function pin for Timer0 external capture pin */
...
{
    printf("This sample code demonstrate timer free counting mode.\n");
    printf("Please connect input source with Timer 0 capture pin PB.15 and\n");
