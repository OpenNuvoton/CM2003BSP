...
void ADC_FunctionTest()
{
    ...
    while(1)
    {
        ...
        printf("  [1] Single end input (channel 4 only)\n");
        ...
        if(u8Option == '1')
        {
            ...
            while(1)
            {
                ...
                /* Get the conversion result of ADC channel 4 */
                i32ConversionData[g_u32COVNUMFlag - 1] = ADC_GET_CONVERSION_DATA(ADC, 4);
            ...
            printf("Conversion result of channel 4:\n");
