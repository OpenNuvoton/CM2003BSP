 ...
 * @version  V3.00
 * @brief
 *           Use PDMA channel 1 to transfer data from memory to memory by scatter-gather mode.
 *
 ...
 * @return      None
 *
 * @details     The DMA default IRQ, declared in startup_CM2003.s.
 */
...
int main(void)
{
    ...
    PDMA_SetTransferMode(PDMA0, 1, PDMA_MEM, 1, (uint32_t)&DMA_DESC[0]);
