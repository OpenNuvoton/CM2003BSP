...
void UART0_Init(void)
{
    ...
    /* Configure UART0: 115200, 8-bit word, no parity bit, 1 stop bit.
       Use UART_Open() so baud rate matches current HIRC (e.g. 40 MHz),
       instead of a hardcoded BAUD value that assumed 24 MHz HIRC. */
...
int32_t main(void)
{
    ...
    /*
       ...
       RO code is placed to 0x20000000 ~ 0x20000C00 with RW is placed to 0x20000C00 ~ 0x20001000.
    */
