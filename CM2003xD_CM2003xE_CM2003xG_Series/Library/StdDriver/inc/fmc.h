 ...
 * $Revision: 11 $
 * $Date: 18/06/20 3:38p $
 * @brief    CM2003 Series Flash Memory Controller Driver Header File
 *
 * @note
...
#define FMC_APROM_SIZE          0x40000UL       /*!< CM2003G APROM Size (256 KB)      */
#elif (CHIP_TYPE == CHIP_TYPE_CM2003E)
#define FMC_APROM_SIZE          0x20000UL       /*!< CM2003E APROM Size (128 KB)      */
#elif (CHIP_TYPE == CHIP_TYPE_CM2003D)
#define FMC_APROM_SIZE          0x10000UL       /*!< CM2003D APROM Size ( 64 KB)      */
#else
#error "Unsupported CHIP_TYPE. Select CHIP_TYPE_CM2003G / CM2003E / CM2003D in chip_type.h"
#endif
