...
#ifndef __SYSTEM_CM2003_H__
#define __SYSTEM_CM2003_H__
...
#define __LIRC      (10000UL)       /*!< Internal 10KHz RC Oscillator Frequency */
  ...
  #if (CM2003G_HIRC == CM2003G_HIRC_32MHZ)
    #define __HIRC      (32000000UL)    /*!< Internal 32M RC Oscillator Frequency */
  #elif (CM2003G_HIRC == CM2003G_HIRC_24MHZ)
