...
#define USCI3_BASE            (APBPERIPH_BASE + 0x93000UL)
...
#define UI2C3                ((UI2C_T *)            USCI3_BASE)
#define USPI3                ((USPI_T *)            USCI3_BASE)
#define UUART3               ((UUART_T *)           USCI3_BASE)
